  ...
  <div>
    ...
    <div class="mt-9 flex flex-col gap-3 sm:flex-row">
      <a class="focus-ring rounded-full bg-ink px-6 py-4 text-center font-semibold text-white transition hover:bg-ember" href="/explore">
        Find a life to borrow
      </a>
      <a class="focus-ring rounded-full border border-line bg-white/60 px-6 py-4 text-center font-semibold text-ink transition hover:bg-white" href="/safety">
        Become a Life Host
      </a>
    </div>
  </div>

  <div class="relative min-h-[520px] overflow-hidden rounded-lg border border-line bg-ink p-6 text-white shadow-soft">
    <video
      class="absolute inset-0 h-full w-full object-cover"
      src="/videos/berlin-software-engineer.mp4"
      poster="https://images.unsplash.com/photo-1534665482403-a909d0d97c67?auto=format&fit=crop&w=1400&q=80"
      autoplay
      muted
      loop
      playsinline
      aria-label="Berlin software engineer public workday rhythm"
    ></video>
    <div class="absolute inset-0 bg-gradient-to-t from-ink via-ink/[0.48] to-ink/10"></div>
    <div class="relative flex h-full flex-col justify-between">
      <div class="flex justify-between text-sm text-white/70">
        <span>Berlin workday rhythm</span>
